...
slider.on("slideChange", function () {
  ...
  const backgroundColor =
    slider.slides[currentIndex].getAttribute("data-background");
  const circleColor = slider.slides[currentIndex].getAttribute("data-circle");
...
const loopSlider = new Swiper(".slider", {
  slidesPerView: 3,
  spaceBetween: 120,
  loop: true,
  speed: 4000,
